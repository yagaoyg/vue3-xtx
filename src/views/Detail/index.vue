...
const addCart = () => {
  if (skuObj.skuId) {
    ...
    cartStore.addCart({
      ...
      pictures: goodsData.value.mainPictures[0],
    ...
    <div class="container" v-if="goodsData.details">
      ...
      <div class="bread-container">
        <el-breadcrumb separator=">">
          ...
          <!-- 
            报错原因：goodsData一开始是{}空的 {}.categories -> undefined -> undefined[1] 报错
            1.使用可选链的语法 ?.
            2.v-if手动控制渲染时机 保证有数据再进行渲染
          -->
            ...
            <div class="goods-article">
              ...
              <div class="goods-tabs">
                ...
                <div class="goods-detail">
                  <!-- 属性 -->
                  <ul class="attrs">
                    <li v-for="item in goodsData.details.properties" :key="item.name">
                      <span class="dt">{{ item.name }}</span>
                      <span class="dd">{{ item.value }}</span>
                    </li>
                  </ul>
                  <!-- 图片 -->
                  <img v-for="item in goodsData.details.pictures" v-img-lazy="item" src="" alt="" :key="item">
                </div>
              </div>
            </div>
            <!-- 24热榜+专题推荐 -->
